...
public class Settings {
	...
	public boolean showTimestamp() {
		return preferences.getBoolean(resources
				.getString(R.string.key_show_timestamp), Boolean
	...
	public boolean showIcons() {
		return preferences
				.getBoolean(resources.getString(R.string.key_show_icons),
	...
	public boolean showColors() {
		return preferences.getBoolean(resources
				.getString(R.string.key_show_colors),
				Boolean.parseBoolean(resources
	...
	public boolean showColorsNick() {
		return preferences.getBoolean(resources
				...
				.parseBoolean(resources
						.getString(R.string.default_show_colors_nick)));
	}
	...
	public boolean use24hFormat() {
		return preferences
				.getBoolean(resources.getString(R.string.key_24h_format),
						Boolean.parseBoolean(resources
	...
	public boolean includeSeconds() {
		return preferences.getBoolean(resources
				...
				.parseBoolean(resources
						.getString(R.string.default_include_seconds)));
	}
	...
	public boolean isReconnectEnabled() {
		return preferences.getBoolean(resources
				.getString(R.string.key_reconnect), Boolean
				.parseBoolean(resources.getString(R.string.default_reconnect)));
	}
	...
	public boolean isIgnoreMOTDEnabled() {
		return preferences.getBoolean(resources
				.getString(R.string.key_ignore_motd),
				Boolean.parseBoolean(resources
						.getString(R.string.default_ignore_motd)));
	}
	...
	public Typeface getFontType() {
		switch (Integer.parseInt(preferences.getString(
				resources.getString(R.string.key_fonttype),
				resources.getString(R.string.default_fonttype)))) {
		default://0 or whatever
	...
	public boolean isTabAsMircEnabled() {
		return preferences.getBoolean(resources
				.getString(R.string.key_tab_as_mirc),
				Boolean.parseBoolean(resources
						.getString(R.string.default_tab_as_mirc)));
	}
	...
	public boolean isKeepSoftkeyOpenEnabled() {
		return preferences.getBoolean(resources
				.getString(R.string.key_keep_softkey_open), Boolean
				.parseBoolean(resources
						.getString(R.string.default_keep_softkey_open)));
	}
	...
	public boolean isVibrateHighlightEnabled() {
		return preferences.getBoolean(resources
				...
				.parseBoolean(resources
						.getString(R.string.default_vibrate_highlight)));
	}
	...
	public boolean isLedHighlightEnabled() {
		return preferences.getBoolean(resources
				.getString(R.string.key_led_highlight), Boolean
				.parseBoolean(resources
	 ...
	 * 
	 * @return True if joins, parts and quits should be displayed, false
	 *         otherwise
	 */
	...
	/**
	 * Should notices be shown in the server window instead in the focused
	 * window?
	 * 
	 ...
	 * 
	 * @return True if colors should be rendered, false if they should be
	 *         removed.
	 */
	public boolean showMircColors() {
		return preferences.getBoolean(resources
				.getString(R.string.key_mirc_colors),
				Boolean.parseBoolean(resources
						.getString(R.string.default_mirc_colors)));
	}

	/**
	 * Render messages with graphical smilies.
	 * 
	 * @return True if text smilies should be rendered as graphical smilies,
	 *         false otherwise.
	 */
	public boolean showGraphicalSmilies() {
		return preferences.getBoolean(resources
				...
				.parseBoolean(resources
						.getString(R.string.default_graphical_smilies)));
	}
	...
	public boolean debugTraffic() {
		return preferences.getBoolean(resources
				.getString(R.string.key_debug_traffic), Boolean
				.parseBoolean(resources
	...
	public boolean autoCapSentences() {
		return preferences.getBoolean(resources
				...
				.parseBoolean(resources
						.getString(R.string.default_autocap_sentences)));
	}
	...
	public boolean imeExtract() {
		return preferences.getBoolean(resources
				.getString(R.string.key_ime_extract),
				Boolean.parseBoolean(resources
						.getString(R.string.default_ime_extract)));
	}
	...
	public int getChannelMaxSize() {
		try {
			...
			return Integer.parseInt(resources
					.getString(R.string.default_channel_max_size));
		}
	}
